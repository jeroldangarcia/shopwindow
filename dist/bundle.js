...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dossiers = __webpack_require__(250);

	var _dossiers2 = _interopRequireDefault(_dossiers);

	var _dossier = __webpack_require__(263);

	var _shopwindow = __webpack_require__(275);

	var _shopwindow2 = _interopRequireDefault(_shopwindow);
	...
	var LoginRequired = function (_React$Component) {
	  _inherits(LoginRequired, _React$Component);
	  ...
	  function LoginRequired() {
	    ...
	    _classCallCheck(this, LoginRequired);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(LoginRequired)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      loggedIn: auth.loggedIn()
	    }, _this.updateAuth = function (logged) {
	      _this.setState({ loggedIn: logged });
	    }, _this.renderLayout = function (children) {
	  ...
	  _createClass(LoginRequired, [{
	    ...
	    value: function render() {
	      var children = _react2.default.cloneElement(this.props.children, { key: this.props.location.pathname });
	      return this.state.loggedIn ? _react2.default.createElement(
	        _layout2.default,
	        null,
	        children
	      ) : _react2.default.createElement(_login2.default, { auth: auth });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layout = function (_React$Component) {
	  ...
	  function Layout(props) {
	    ...
	    _this.state = { drawer: false, dialog: false };
	  ...
	  _createClass(Layout, [{
	    key: 'toggleDrawer',
	    value: function toggleDrawer(forced) {
	    ...
	    key: 'render',
	    value: function render() {
	      var overlayClass = this.state.drawer || this.state.dialog ? '' : 'hidden';
	      var drawerClass = this.state.drawer ? 'uncoverleft' : '';
	      var dialogClass = this.state.dialog ? '' : 'hidden';
	      return _react2.default.createElement(
	        'div',
	        { className: 'layout' },
	        _react2.default.createElement(
	          'div',
	          { className: 'overlay ' + overlayClass + ' centred', onClick: this.toggleOverlay },
	          _react2.default.createElement(
	            'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { id: 'searchbar', onClick: this.toggleDialog },
	            'searchbox'
	          ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _widgets = __webpack_require__(241);
	...
	var LoginPage = function (_React$Component) {
	  ...
	  function LoginPage() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(LoginPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.defaultProps = {
	      tab: 'SIGNIN'
	    }, _this.state = {
	      tab: _this.defaultProps.tab
	    }, _this.handleTabChanged = function (tabb) {
	      _this.setState({ tab: tabb });
	    }, _this.handleSignIn = function (name, password) {
	      _this.props.auth.login(name, password, function (loggedIn) {
	        if (!loggedIn) {
	          return _this.setState({ error: 'Login Error' });
	        }
	      });
	  ...
	  _createClass(LoginPage, [{
	    ...
	    value: function render() {
	      var widgets = {
	        SIGNIN: _react2.default.createElement(_widgets.SignIn, { onSubmit: this.handleSignIn, error: this.state.error }),
	        SIGNUP: _react2.default.createElement(_widgets.SignUp, { onSubmit: this.handleSignUp })
	      };
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_tabs.Tab, { id: 'SIGNIN', label: 'Sign In', active: this.state.tab === 'SIGNIN' }),
	            _react2.default.createElement(_tabs.Tab, { id: 'SIGNUP', label: 'Sign Up', active: this.state.tab === 'SIGNUP' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'form' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tab = function Tab(props) {
	  var icon = props.icon ? materialIcon(props.icon) : null;
	  var activeClass = props.active ? 'selected' : '';
	...
	var Tabs = function Tabs(props) {
	  var tabs = _react2.default.Children.map(props.children, function (child) {
	    return _react2.default.cloneElement(child, { onMouseUp: props.onChanged });
	  });
	  return _react2.default.createElement(
	    'nav',
	    { className: 'tabbar' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fields = __webpack_require__(245);
	...
	var SignIn = function (_React$Component) {
	  ...
	  function SignIn() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SignIn)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.defaultProps = {
	      name: 'jeroldan@gmail.com',
	      password: 'xxxxxxxx'
	    }, _this.state = {
	      name: _this.defaultProps.name,
	      password: _this.defaultProps.password
	    }, _this.onSignIn = function () {
	      // TODO: fields validations
	      _this.props.onSubmit(_this.state.name, _this.state.password);
	    }, _this.onChangeName = function (newName) {
	      _this.setState({ name: newName });
	    }, _this.onChangePassword = function (newPassword) {
	      _this.setState({ password: newPassword });
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  _createClass(SignIn, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_fields.Field, { label: 'Email', value: this.state.name, onChange: this.onChangeName }),
	        _react2.default.createElement(_fields.Field, { label: 'Password', value: this.state.password, onChange: this.onChangePassword }),
	        _react2.default.createElement(
	          'div',
	          null,
	          this.props.error
	        ),
	        _react2.default.createElement(_buttons.FAB, { icon: 'arrow_forward', to: '', onMouseUp: this.onSignIn })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.materialIcon = exports.FAB = exports.CheckButton = exports.Button = exports.IconButton = exports.Icon = undefined;
	...
	var Button = function Button(props) {
	  ...
	  var onMouseUp = props.classes === 'disabled' ? null : props.onMouseUp;

	  return _react2.default.createElement(
	    'button',
	    { id: props.id, className: 'button ' + props.classes, onMouseUp: onMouseUp },
	...
	var IconButton = function IconButton(props) {
	  return _react2.default.createElement(
	    'button',
	    { id: props.id, className: 'ibutton ' + props.classes, onMouseUp: props.onMouseUp },
	    props.icon ? materialIcon(props.icon) : null
	  );
	};
	...
	var FAB = function FAB(props) {
	  return _react2.default.createElement(
	    _reactRouter.Link,
	    { to: props.to },
	    _react2.default.createElement(IconButton, { icon: props.icon, classes: 'fab', onMouseUp: props.onMouseUp })
	  );
	};
	...
	var CheckButton = function CheckButton(props) {
	  ...
	  var handleValueChange = function handleValueChange() {
	    var v = Object.keys(icons).indexOf(props.value);
	    var nextValue = Object.keys(icons)[(v + 1) % 3];
	    props.onValueChanged(props.id, nextValue);
	  };

	  var icon = icons[props.value];

	  return _react2.default.createElement(IconButton, { icon: icon, onMouseUp: handleValueChange });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Field = function (_React$Component) {
	  ...
	  function Field() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Field)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleChange = function (e) {
	...
	var Checkbox = function Checkbox(props) {
	  ...
	  var label = props.checkedLabel ? props.checked ? props.checkedLabel : props.label : props.label;
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'checkbox mui-checkbox' },
	      _react2.default.createElement(
	        'label',
	        null,
	        _react2.default.createElement('input', { id: props.id, type: 'checkbox', checked: checked, onClick: handleChange }),
	        label
	      )
	    )
	  );
	...
	Checkbox.propTypes = {
	  ...
	  checkedLabel: _react2.default.PropTypes.string,
	  onChange: _react2.default.PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./fields.css", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./fields.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inbox = __webpack_require__(257);
	...
	var _dossiers = __webpack_require__(272);
	...
	var Dossiers = function (_React$Component) {
	  ...
	  _createClass(Dossiers, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        _page.Page,
	        { title: 'DOSSIERS', icon: 'content_copy', toggleDrawer: this.props.toggleDrawer },
	        _react2.default.createElement(
	          _inbox.Inbox,
	          null,
	          _react2.default.createElement(
	...
	Dossiers.propTypes = {
	  toggleDrawer: _react2.default.PropTypes.func
	};
	exports.default = Dossiers;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function Header(props) {
	  var goBack = function goBack() {
	    _reactRouter.browserHistory.push(props.to);
	  };
	  ...
	  var searchButton = _react2.default.createElement(_buttons.IconButton, { id: 'search-button', icon: 'search', onClick: goSearch });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.InboxViewer = exports.InboxList = exports.Inbox = undefined;
	...
	var InboxList = function (_React$Component) {
	  _inherits(InboxList, _React$Component);

	  function InboxList() {
	    _classCallCheck(this, InboxList);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InboxList).apply(this, arguments));
	  }
	  ...
	  _createClass(InboxList, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'inbox-list ' + openClass },
	        this.props.children
	      );
	    }
	  }]);
	...
	var InboxViewer = function (_React$Component2) {
	  ...
	  function InboxViewer() {
	    _classCallCheck(this, InboxViewer);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InboxViewer).apply(this, arguments));
	  }

	  _createClass(InboxViewer, [{
	    key: 'render',
	    value: function render() {
	      var openClass = this.props.open ? 'open' : '';
	      return _react2.default.createElement(
	        'div',
	        { className: 'inbox-viewer ' + openClass },
	        this.props.children
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DossierCheckin = function (_React$Component) {
	  _inherits(DossierCheckin, _React$Component);

	  function DossierCheckin() {
	    var _Object$getPrototypeO;

	    var _temp, _this, _ret;

	    _classCallCheck(this, DossierCheckin);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(DossierCheckin)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      reception: 'none',
	      receptionOK: 'none',
	      product: 'none',
	      productOK: 'none',
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_buttons.CheckButton, { id: 'product', value: this.state.product, onValueChanged: this.handleChecked }),
	          _react2.default.createElement(_buttons.CheckButton, { id: 'productOK', value: this.state.productOK, onValueChanged: this.handleChecked })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'line' },
	          ...
	          _react2.default.createElement(_buttons.CheckButton, { id: 'profiled', value: this.state.profiled, onValueChanged: this.handleChecked }),
	          _react2.default.createElement(_buttons.CheckButton, { id: 'profiledOK', value: this.state.profiledOK, onValueChanged: this.handleChecked })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'line' },
	          ...
	          _react2.default.createElement(_buttons.CheckButton, { id: 'lighting', value: this.state.lighting, onValueChanged: this.handleChecked }),
	          _react2.default.createElement(_buttons.CheckButton, { id: 'lightingOK', value: this.state.lightingOK, onValueChanged: this.handleChecked })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'line' },
	          ...
	          _react2.default.createElement(_buttons.CheckButton, { id: 'opening', value: this.state.opening, onValueChanged: this.handleChecked }),
	          _react2.default.createElement(_buttons.CheckButton, { id: 'openingOK', value: this.state.openingOK, onValueChanged: this.handleChecked })
	        )
	      );
	    }
	  }]);
	...
	var DossierShopWindow = function (_React$Component2) {
	  ...
	  function DossierShopWindow() {
	    ...
	    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(DossierShopWindow)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this2), _this2.handleAddShopWindow = function () {
	    ...
	    }, _this2.handleCardSelected = function () {
	      _reactRouter.browserHistory.push('/shopwindow');
	    }, _temp2), _possibleConstructorReturn(_this2, _ret2);
	  }
	  ...
	  _createClass(DossierShopWindow, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_buttons.FAB, { icon: 'add_a_photo', to: '/shopwindow', onMouseUp: this.handleAddShopWindow })
	      );
	    }
	  }]);
	...
	var DossierReport = function (_React$Component3) {
	  _inherits(DossierReport, _React$Component3);

	  function DossierReport() {
	    _classCallCheck(this, DossierReport);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(DossierReport).apply(this, arguments));
	  }

	  _createClass(DossierReport, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'article',
	...
	var Dossier = function (_React$Component4) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _tabs.Tabs,
	            { onChanged: this.handleChangeTab },
	            _react2.default.createElement(_tabs.Tab, { id: 'checkin', label: 'Check-In', active: this.state.tab === 'checkin' }),
	            _react2.default.createElement(_tabs.Tab, { id: 'gallery', label: 'Gallery', active: this.state.tab === 'gallery' }),
	            _react2.default.createElement(_tabs.Tab, { id: 'report', label: 'Report', active: this.state.tab === 'report' })
	          )
	        ),
	        _react2.default.createElement(
	          'main',
	          null,
	          this.renderContent(),
	          _react2.default.createElement(_buttons.FAB, { icon: 'subdirectory_arrow_left', to: '', onMouseUp: this.props.done })
	        )
	      );
	    }
	  }]);
	...
	var NewDossier = function (_React$Component5) {
	  ...
	  function NewDossier() {
	    ...
	    return _ret4 = (_temp4 = (_this5 = _possibleConstructorReturn(this, (_Object$getPrototypeO4 = Object.getPrototypeOf(NewDossier)).call.apply(_Object$getPrototypeO4, [this].concat(args))), _this5), _this5.defaultProps = {
	      step: 1
	    }, _this5.state = {
	      step: _this5.defaultProps.step
	    }, _this5.steps = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Step = function Step(props) {
	  return _react2.default.createElement(
	    'div',
	    { id: props.id, className: 'step mui-panel' },
	    props.children
	  );
	};
	...
	var Stepper = function (_React$Component) {
	  ...
	  function Stepper() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Stepper)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleBack = function () {
	      _this.props.onStepChanged(_this.props.step - 1);
	    }, _this.handleNext = function () {
	      _this.props.onStepChanged(_this.props.step + 1);
	    }, _this.renderDots = function () {
	      return _this.props.steps.map(function (item) {
	        var selectedClass = item == _this.props.step ? 'selected' : '';
	  ...
	  _createClass(Stepper, [{
	    ...
	    value: function render() {
	      ...
	      var backButtonClass = this.props.step === 1 ? 'disabled' : '';
	      var nextButtonClass = this.props.step === this.props.steps.length ? 'disabled' : '';
	      return _react2.default.createElement(
	        'div',
	        { className: 'stepper' },
	        _react2.default.createElement(_buttons.Button, { icon: 'arrow_left', label: 'BACK', onMouseUp: this.handleBack, classes: backButtonClass }),
	        _react2.default.createElement(
	          'div',
	          { className: 'flex' },
	          this.renderDots()
	        ),
	        _react2.default.createElement(_buttons.Button, { icon: 'arrow_right', label: 'NEXT', onMouseUp: this.handleNext, classes: nextButtonClass })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./steps.css", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./steps.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = function (_React$Component) {
	  ...
	  function Card() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Card)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleCardSelected = function () {
...
/***/ function(module, exports) {
	...
	var DossierStore = {
	  ...
	  centers: [{ label: 'Hermosilla', value: '0008' }, { label: 'Castellana', value: '0009' }, { label: 'Valencia', value: '0010' }],
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./dossier.css", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./dossier.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShopWindow = function (_React$Component) {
	  _inherits(ShopWindow, _React$Component);

	  function ShopWindow() {
	    _classCallCheck(this, ShopWindow);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ShopWindow).apply(this, arguments));
	  }

	  _createClass(ShopWindow, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        _page.Page,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'screen' },
	              _react2.default.createElement('img', { src: '/images/escaparate1.jpg', width: '100%' })
	            )
	          ),
	          _react2.default.createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./cinema.css", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./cinema.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
